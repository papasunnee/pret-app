                  ...
                  ({ payments }) => <Fragment>                   
                    {payments.length == 0 &&  
                      <div style={{marginTop: '100px', textAlign: 'center'}}>
                        <h3 >You have not made any payment, Yet</h3><br/>
                    ...
                    <Table responsive hover style={{width: '100%'}}>
                      ...
                      <tbody>
                        {payments.map((payment, index)=>(
                          <tr>
                            <td>{index+1}</td>
                            <td>{payment.testCode? payment.testCode : 'Not available'}</td>
                            <td>
                            {payment.paystackReference || 'Not available'}
                            </td>
                            <td>
                            {payment.amount ? `${payment.currency} ${payment.amount}` : 'Not available'}
                            </td>
                            <td>
                            {payment.createdAt ?
