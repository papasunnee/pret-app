...
} from "../../contexts/CandidateSchedulesContext";
              ...
              <Fragment>
                {candidateUpcomingTests.length == 0 && (
                  <div style={{ marginTop: "100px", textAlign: "center" }}>
                    <h3>We have not Scheduled any PRET test, for now</h3>
                    <br />
                    ...
                    <tbody>
                      {candidateUpcomingTests.map((test, index) => (
                        <tr>
                          ...
                          <td>
                            {test.isBooked ? (
                              <ScheduleButton candidateUpcomingTest={test} />
                            ) : (
...
export default withCandidatePortal(ScheduleTestPage, {
  activePage: "/schedule-test"
});
